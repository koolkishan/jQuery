!(function (a, b, c, d) {
  ...
  function P(a, b) {
    ...
    for (e = 0; e < g.length; )
      d[g[e].identifier] && h.push(g[e]),
        b & (yb | zb) && delete d[g[e].identifier],
        e++;
  ...
  function Q() {
    ...
    (this.touch = new O(this.manager, a)),
  ...
  function cb(a, b) {
    return (
      (b = b || {}),
      (b.recognizers = m(b.recognizers, cb.defaults.preset)),
      new db(a, b)
    );
  }
  function db(a, b) {
    (b = b || {}),
      (this.options = i(b, cb.defaults)),
      ...
      (this.element = a),
      (this.input = z(this)),
      (this.touchAction = new R(this, this.options.touchAction)),
      eb(this, !0),
      g(
        b.recognizers,
        function (a) {
  ...
  var Kb = { mousedown: wb, mousemove: xb, mouseup: yb },
    Lb = "mousedown",
    Mb = "mousemove mouseup";
  j(M, y, {
    handler: function (a) {
      var b = Kb[a.type];
      b & wb && 0 === a.button && (this.pressed = !0),
        b & xb && 1 !== a.which && (b = yb),
        this.pressed &&
          this.allow &&
          (b & yb && (this.pressed = !1),
  ...
  var Nb = {
    ...
    Ob = { 2: rb, 3: sb, 4: tb, 5: ub },
    Pb = "pointerdown",
    Qb = "pointermove pointerup pointercancel";
  a.MSPointerEvent &&
    ((Pb = "MSPointerDown"),
    (Qb = "MSPointerMove MSPointerUp MSPointerCancel")),
    j(N, y, {
      handler: function (a) {
        var b = this.store,
          c = !1,
  ...
  var Rb = { touchstart: wb, touchmove: xb, touchend: yb, touchcancel: zb },
  ...
  R.prototype = {
    set: function (a) {
      a == Vb && (a = this.compute()),
        Ub && (this.manager.element.style[Tb] = a),
  ...
  (T.prototype = {
    ...
    dropRecognizeWith: function (a) {
      return f(a, "dropRecognizeWith", this)
        ? this
        : ((a = W(a, this)), delete this.simultaneous[a.id], this);
    },
    ...
    recognize: function (a) {
      ...
      return l(this.options.enable, [this, b])
        ? (this.state & (dc | ec | fc) && (this.state = _b),
          (this.state = this.process(b)),
          void (this.state & (ac | bc | cc | ec) && this.tryEmit(b)))
        : (this.reset(), void (this.state = fc));
    },
    process: function () {},
    ...
    j(Y, X, {
      defaults: { event: "pan", threshold: 10, pointers: 1, direction: Hb },
      getTouchAction: function () {
      ...
      attrTest: function (a) {
        return (
          X.prototype.attrTest.call(this, a) &&
          (this.state & ac || (!(this.state & ac) && this.directionTest(a)))
        );
      },
      emit: function (a) {
    ...
    j(Z, X, {
      ...
      attrTest: function (a) {
        return (
          ...
          (Math.abs(a.scale - 1) > this.options.threshold || this.state & ac)
        );
      },
      emit: function (a) {
    ...
    j($, T, {
      ...
      process: function (a) {
        ...
        if (((this._input = a), !d || !c || (a.eventType & (yb | zb) && !f)))
          this.reset();
        else if (a.eventType & wb)
          this.reset(),
            (this._timer = e(
              function () {
    ...
    j(_, X, {
      ...
      attrTest: function (a) {
        return (
          this._super.attrTest.call(this, a) &&
          (Math.abs(a.rotation) > this.options.threshold || this.state & ac)
        );
      },
    }),
    j(ab, X, {
    ...
    j(bb, T, {
      ...
      process: function (a) {
        var b = this.options,
          ...
          d = a.distance < b.threshold,
          f = a.deltaTime < b.time;
        if ((this.reset(), a.eventType & wb && 0 === this.count))
    ...
    recognize: function (a) {
      ...
      if (!b.stopped) {
        ...
        for (var f = 0; f < d.length; )
          (c = d[f]),
            b.stopped === hc || (e && c != e && !c.canRecognizeWith(e))
              ? c.reset()
              : c.recognize(a),
            !e && c.state & (ac | bc | cc) && (e = b.curRecognizer = c),
            f++;
      }
    },
    get: function (a) {
